 ...
 * Templating API for scanning front side, check class {@link ColombiaIDBackSide}.
 * <p/>
 ...
 */
public class ColombiaIDBackSide {
    ...
    private static class CroBackIdClassifier implements MRTDDocumentClassifier {
         ...
         */
        public static final Creator<CroBackIdClassifier> CREATOR = new Creator<ColombiaIDBackSide.CroBackIdClassifier>() {
            @Override
            public ColombiaIDBackSide.CroBackIdClassifier createFromParcel(Parcel source) {
                return new ColombiaIDBackSide.CroBackIdClassifier();
            }

            @Override
            public ColombiaIDBackSide.CroBackIdClassifier[] newArray(int size) {
                return new ColombiaIDBackSide.CroBackIdClassifier[size];
            }
        };
    }
}
