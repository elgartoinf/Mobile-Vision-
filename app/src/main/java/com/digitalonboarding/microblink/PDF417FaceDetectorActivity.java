package com.digitalonboarding.microblink;
...
import com.digitalonboarding.CompareFacesActivity;
import com.digitalonboarding.Functions;
import com.digitalonboarding.R;
...
public class PDF417FaceDetectorActivity extends AppCompatActivity implements CameraEventsListener,
    ScanResultListener, MetadataListener, OnSizeChangedListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    settings.setRecognizerSettingsArray(new RecognizerSettings[]{drs,new Pdf417RecognizerSettings()});
    ...
    if (v != null) {
      //  it to the current layout that contains the recognizer view
    ...
    mBtnSave.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        String url = MediaStore.Images.Media.insertImage(PDF417FaceDetectorActivity.this.getContentResolver(), mShownBitmap, "Detected Image", "");
        Log.i(PDF417FaceDetectorActivity.this, "Image saved to URL {}", url);
    ...
    mQuadViewManager = QuadViewManagerFactory
        .createQuadViewFromPreset(mRecognizerView, QuadViewPreset.DEFAULT_FROM_SCAN_CARD_ACTIVITY);
          ...
          mRecognizerView.setTorchState(!mTorchEnabled, new SuccessCallback() {
            ...
            public void onOperationDone(final boolean success) {
              runOnUiThread(new Runnable() {
                @Override
                public void run() {
                  Log.d(PDF417FaceDetectorActivity.this, "Setting torch to {}. Success: {}", !mTorchEnabled, success);
                  if (success) {
  ...
  public void onAutofocusFailed() {
    ...
    Log.e("autofocus",getString(R.string.autofocus_fail));
  }
  ...
  private void showResult() {
    if(mLastDewarpedImg != null ) {
      ...
      Functions.barcode = barcode;
      android.util.Log.e("barcode Argentina ",barcode);
      Functions.bitmap2 = new BitmapDrawable(getResources(), mShownBitmap);
      Intent i = new Intent(getBaseContext(),CompareFacesActivity.class);
