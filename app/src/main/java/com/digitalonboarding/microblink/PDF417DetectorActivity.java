...
public class PDF417DetectorActivity extends AppCompatActivity implements ScanResultListener, CameraEventsListener, MetadataListener {
  ...
  /**
   * CameraPermissionManager is provided helper class that can be used to obtain the permission to
   * use camera.
  ...
  /**
   * This is a builtin point set view that can visualize points of interest, such as those of QR
   * code
   */
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_pdf417_detector);
    ...
    if (extras != null) {
      ...
      RecognitionSettings recognitionSettings = extras
          .getParcelable(Pdf417ScanActivity.EXTRAS_RECOGNITION_SETTINGS);
    ...
    mQvManager = QuadViewManagerFactory.createQuadViewFromPreset(mRecognizerView,
        QuadViewPreset.DEFAULT_CORNERS_FROM_PDF417_SCAN_ACTIVITY);
    ...
    mLayout = getLayoutInflater()
        .inflate(R.layout.default_barcode_camera_overlay, null);
