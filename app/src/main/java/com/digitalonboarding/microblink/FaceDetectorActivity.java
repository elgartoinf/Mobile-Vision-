...
public class FaceDetectorActivity extends AppCompatActivity implements CameraEventsListener, ScanResultListener, MetadataListener, OnSizeChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = MediaStore.Images.Media.insertImage(getContentResolver(), mShownBitmap, "Detected Image", "");
                Log.i(this, "Image saved to URL {}", url);
        ...
        mQuadViewManager = QuadViewManagerFactory.createQuadViewFromPreset(mRecognizerView, QuadViewPreset.DEFAULT_FROM_SCAN_CARD_ACTIVITY);
                    ...
                    mRecognizerView.setTorchState(!mTorchEnabled, new SuccessCallback() {
                        ...
                        public void onOperationDone(final boolean success) {
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Log.d(this, "Setting torch to {}. Success: {}", !mTorchEnabled, success);
                                    if (success) {
