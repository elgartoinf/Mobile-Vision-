...
class BarcodeTrackerFactory implements MultiProcessor.Factory<Barcode> {
    ...
    BarcodeTrackerFactory(GraphicOverlay graphicOverlay, MultiTrackerActivity context) {
...
class BarcodeGraphic extends TrackedGraphic<Barcode> {
    ...
    BarcodeGraphic(GraphicOverlay overlay, MultiTrackerActivity context) {
        super(overlay);
        this.context = context;
    ...
    void updateItem(Barcode barcode) {
        mBarcode = barcode;
        Functions.barcode = barcode.displayValue;
        postInvalidate();
